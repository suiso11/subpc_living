...
> **状態**: active / canonical
> **位置付け**: 開発委譲運用の正典
> **対象範囲**: Pi / pi-orch による委譲・役割分担・セキュリティ境界・検証
> **作成日**: 2026-07-05
> **更新日**: 2026-08-27
> **日付根拠**: Git commit date。リネーム履歴の信頼度は限定的（52%類似）
...
プロジェクトの現行サポート基準はPi 0.84以上。0.79は上流/レガシー側の最低要件
（hard floor）としてのみ残しており、必要なら先にPi本体を0.84以上へ更新する。
