> **状態**: reference / non-authoritative
> **位置付け**: 外部AIが生成した参考コード・提案の控え。設計として採用済みではない。現在のプライバシー・センサーポリシーは `../plans/companion_roadmap.md` を優先
> **対象範囲**: リポジトリに対するAI提案の記録（STT/TTS/VAD/LLMパイプラインの参考コード）
> **作成日**: 2026-02-11
> **更新日**: 2026-08-27
> **日付根拠**: Git commit date（初版2026-02-11。2026-06-28のrestore/rename履歴99%を経た現パス）
